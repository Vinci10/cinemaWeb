...
public interface ReservationRepository extends CrudRepository<Reservation,Integer>{
    ...
    @Query("select place from Reservation r where movie_name = :name and room=:room and day=:day and time=:time")
    List<Integer> getPlacesByMovienameAndDayAndTimeAndRoom(@Param("name") String name, @Param("day") Date day, @Param("time") Time time, @Param("room") int room);
